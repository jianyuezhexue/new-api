...
<p align="center">
  ...
  --><a href="https://www.producthunt.com/products/new-api/launches/new-api?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-new-api" target="_blank" rel="noopener noreferrer">
    <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1047693&theme=light&t=1769577875005" alt="build & block - All-in-one AI asset management gateway. | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" />
  </a>
</p>
...
📖 Pour plus de méthodes de déploiement, veuillez vous référer à [Guide de déploiement](https://tokens-doc.buildingblock.top/en/docs/installation)
...
### 📖 [Documentation officielle](https://tokens-doc.buildingblock.top/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/new-api)
...
| Catégorie | Lien |
|------|------|
| 🚀 Guide de déploiement | [Documentation d'installation](https://tokens-doc.buildingblock.top/en/docs/installation) |
| ⚙️ Configuration de l'environnement | [Variables d'environnement](https://tokens-doc.buildingblock.top/en/docs/installation/config-maintenance/environment-variables) |
| 📡 Documentation de l'API | [Documentation de l'API](https://tokens-doc.buildingblock.top/en/docs/api) |
| ❓ FAQ | [FAQ](https://tokens-doc.buildingblock.top/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://tokens-doc.buildingblock.top/en/docs/support/community-interaction) |

---

## ✨ Fonctionnalités clés

> Pour les fonctionnalités détaillées, veuillez vous référer à [Présentation des fonctionnalités](https://tokens-doc.buildingblock.top/en/docs/guide/wiki/basic-concepts/features-introduction) |
...
- ⚡ [OpenAI Responses](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/realtime/create-realtime-session) (y compris Azure)
- ⚡ [Claude Messages](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://doc.newapi.pro/en/api/google-gemini-chat)
- 🔄 [Modèles Rerank](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/rerank/create-rerank) (Cohere, Jina)
...
> Pour les détails, veuillez vous référer à [Documentation de l'API - Interface de passerelle](https://tokens-doc.buildingblock.top/en/docs/api)

| Type de modèle | Description | Documentation |
|---------|------|------|
| 🤖 OpenAI-Compatible | Modèles compatibles OpenAI | [Documentation](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | Format OpenAI Responses | [Documentation](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [Documentation](https://doc.newapi.pro/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [Documentation](https://doc.newapi.pro/api/suno-music) |
| 🔄 Rerank | Cohere, Jina | [Documentation](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/rerank/creatererank) |
| 💬 Claude | Format Messages | [Documentation](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Format Google Gemini | [Documentation](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | Mode ChatFlow | - |
...
- [Interface de discussion (Chat Completions)](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/chat/openai/createchatcompletion)
- [Interface de réponse (Responses)](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/chat/openai/createresponse)
- [Interface d'image (Image)](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/images/openai/post-v1-images-generations)
- [Interface audio (Audio)](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/audio/openai/create-transcription)
- [Interface vidéo (Video)](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/audio/openai/createspeech)
- [Interface d'incorporation (Embeddings)](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/embeddings/createembedding)
- [Interface de rerank (Rerank)](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/rerank/creatererank)
- [Conversation en temps réel (Realtime)](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/realtime/createrealtimesession)
- [Discussion Claude](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/chat/createmessage)
- [Discussion Google Gemini](https://tokens-doc.buildingblock.top/en/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
📖 **Configuration complète:** [Documentation des variables d'environnement](https://tokens-doc.buildingblock.top/en/docs/installation/config-maintenance/environment-variables)
...
| [new-api-horizon](https://github.com/Calcium-Ion/new-api-horizon) | Version optimisée haute performance de build & block |
...
| 📘 FAQ | [FAQ](https://tokens-doc.buildingblock.top/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://tokens-doc.buildingblock.top/en/docs/support/community-interaction) |
| 🐛 Commentaires sur les problèmes | [Commentaires sur les problèmes](https://tokens-doc.buildingblock.top/en/docs/support/feedback-issues) |
| 📚 Documentation complète | [Documentation officielle](https://tokens-doc.buildingblock.top/en/docs) |
...
### 💖 Merci d'utiliser build & block

Si ce projet vous est utile, bienvenue à nous donner une ⭐️ Étoile！

**[Documentation officielle](https://tokens-doc.buildingblock.top/en/docs)** • **[Commentaires sur les problèmes](https://github.com/Calcium-Ion/new-api/issues)** • **[Dernière version](https://github.com/Calcium-Ion/new-api/releases)**
