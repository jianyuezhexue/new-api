...
- [官方文档](https://tokens-doc.buildingblock.top/zh/docs/installation)
- [环境变量配置](https://tokens-doc.buildingblock.top/zh/docs/installation/config-maintenance/environment-variables)
- [常见问题](https://tokens-doc.buildingblock.top/zh/docs/support/faq)
