# build & block Electron Desktop App

This directory contains the Electron wrapper for build & block, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
- **Production**:
  - macOS: `~/Library/Application Support/build & block/data/`
  - Windows: `%APPDATA%/build & block/data/`
  - Linux: `~/.config/build & block/data/`
