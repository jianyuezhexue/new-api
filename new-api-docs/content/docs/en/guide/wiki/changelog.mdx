...
<Callout type="warn" title="Version Log Information · Data updated at 2026-8-4 08:19:12">
...
Highlights: This release expands provider and channel compatibility with build & block channels, DeepSeek Responses API support, zstd request decompression, and automatic group routing. It also improves operational accuracy with stream visibility in logs, more reliable tiered-retry billing, and upstream Bedrock cancellation when clients disconnect.

### New Features
- Added build & block channel support with Gemini-to-OpenAI streaming conversion, Advanced Custom Responses Compact handling, and multipart image edit support (#6559).
...
* fix(relay): preserve multipart image edits for build & block channels by @seefs001 in https://github.com/QuantumNous/new-api/pull/6559
