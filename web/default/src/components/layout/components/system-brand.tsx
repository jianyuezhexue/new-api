...
export function SystemBrand(props: SystemBrandProps) {
  ...
  const name = status?.system_name || props.defaultName || 'build & block'
  const version =
  ...
  if (variant === 'inline') {
    return (
      ...
      >
        <div className='flex size-[13px] items-center justify-center overflow-hidden rounded-md'>
          <img
            src={logo}
            alt={t('Logo')}
    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <SidebarMenuButton
          ...
          render={<div />}
        >
          <div className='flex aspect-square size-[21px] items-center justify-center overflow-hidden rounded-lg'>
            <img
              src={logo}
              alt={t('Logo')}
